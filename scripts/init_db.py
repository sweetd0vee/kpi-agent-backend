"""
Создание таблиц БД (board_goals, leader_goals, strategy_goals, process_registry, staff).
...
def main():
    ...
    init_db()
    print("Таблицы созданы: board_goals, leader_goals, strategy_goals, process_registry, staff")
